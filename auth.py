"""JWT role-based authentication for the root SAHILABEL app."""
...
async def login(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    return TokenResponse(access_token=create_access_token(form_data.username, user["role"]), role=user["role"])
