...
class InspectorReview:
    def __init__(self, *, reviewer: str, automated_decision: Any, inspector_decision: str,
                 reason: str | None = None, field_confirmations: dict[str, Any] | None = None,
    ...
    def to_dict(self) -> dict[str, Any]:
        timestamp = self.reviewed_at.isoformat() if isinstance(self.reviewed_at, datetime) else str(self.reviewed_at)
        return {
...
def create_inspector_review(*, reviewer: str, automated_decision: Any, inspector_decision: str,
                            reason: str | None = None, field_confirmations: dict[str, Any] | None = None,
                            reviewed_at: datetime | None = None) -> InspectorReview:
